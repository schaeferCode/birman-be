...
var verifyBearer = function (authorization) {
...
module.exports = {
    verify: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var token, payload, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    token = verifyBearer(req.headers.authorization);
        ...
        return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!rolesAsString.includes(role)) {
                    return [2 /*return*/, res.status(400).send("This page is restricted to " + rolesAsString + "s only")];
                }
                next();
                return [2 /*return*/];
            });
